    ...
    <section id="about" className="section-reveal section-reveal-delay-1 scroll-mt-20">
      <div className="mx-auto w-full max-w-5xl px-1 sm:px-0">
        <div className="grid grid-cols-1 gap-4 md:gap-5 lg:grid-cols-3">
          <FadeContent duration={700} delay={0} translateY={30} className="col-span-1 lg:col-span-2">
            <WobbleCard
              containerClassName="min-h-[240px] bg-gradient-to-br from-sky-700 via-cyan-700 to-teal-900 lg:min-h-[280px]"
          ...
          <FadeContent duration={700} delay={120} translateY={30}>
            <WobbleCard
              containerClassName="min-h-[240px] bg-gradient-to-br from-emerald-600 via-teal-700 to-cyan-900 lg:min-h-[280px]"
          ...
          <FadeContent duration={700} delay={200} translateY={30} className="col-span-1 lg:col-span-3">
            <WobbleCard
              containerClassName="min-h-[260px] bg-gradient-to-br from-slate-800 via-blue-900 to-cyan-950 lg:col-span-3 lg:min-h-[320px]"
