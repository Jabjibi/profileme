...
export function ContactSection() {
  return (
    <section id="contact" className="section-reveal section-reveal-delay-3 mt-24 scroll-mt-20">
      <Card className="relative overflow-hidden rounded-3xl border-slate-700/80 bg-slate-950/70 text-slate-100 shadow-[0_25px_80px_rgba(0,0,0,0.45)]">
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute -left-20 top-0 h-56 w-56 rounded-full bg-emerald-500/15 blur-3xl" />
          <div className="absolute -right-16 bottom-0 h-64 w-64 rounded-full bg-blue-500/15 blur-3xl" />
          <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-slate-200/50 to-transparent" />
        </div>
        ...
        <div className="relative grid gap-0 lg:grid-cols-[1.08fr_1fr]">
          <CardHeader className="space-y-6 border-b border-slate-800/80 p-7 sm:p-10 lg:border-b-0 lg:border-r lg:border-slate-800/80">
            <span className="inline-flex w-fit items-center rounded-full border border-emerald-400/40 bg-emerald-400/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.14em] text-emerald-300">
              Let&apos;s Collaborate
            </span>
              ...
              {channels.map((channel) => (
                ...
                >
                  <span className="inline-flex min-w-0 items-center gap-3">
                    <span className="inline-flex size-9 shrink-0 items-center justify-center rounded-full border border-slate-600/70 bg-slate-800/80 text-slate-100 transition-colors group-hover:border-emerald-400/60 group-hover:text-emerald-300">
